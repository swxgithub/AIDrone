...
import knnalgorithmImage from './translate/translate.png';
import knnalgorithmInsetImage from './translate/translate-small.png';

import tensorflowImage from './TensorFlow/TensorFlow.png';
import tensorflowInsetImage from './TensorFlow/TensorFlow-small.png';

import openaiImage from './openai/openai.png';
import openaiInsetImage from './openai/openai-small.png';

import arduinoImage from './arduino/arduino.png';
import arduinoInsetImage from './arduino/arduino-small.png';

import raspberryPieImage from './raspberryPie/raspberryPie.png';
import raspberryPieInsetImage from './raspberryPie/raspberryPie-small.png';
...
export default [
    ...
    },
    {
        ...
        iconURL: tensorflowImage,
        insetIconURL: tensorflowInsetImage,
        description: (
            <FormattedMessage
                defaultMessage="tensorflow"
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="OpenAI Gym"
                description="Name for the 'OpenAI Gym' extension"
                id="gui.extension.openai.name"
            />
        ),
        extensionId: 'openai',
        iconURL: openaiImage,
        insetIconURL: openaiInsetImage,
        description: (
            <FormattedMessage
                defaultMessage="OpenAI Gym"
                description="Description for the 'OpenAI Gym' extension"
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="raspberryPie"
                description="Name for the 'raspberryPie' extension"
                id="gui.extension.raspberryPie.name"
            />
        ),
        extensionId: 'raspberryPie',
        iconURL: raspberryPieImage,
        insetIconURL: raspberryPieInsetImage,
        description: (
            <FormattedMessage
                defaultMessage="OpenAI Gym"
                description="Description for the 'raspberryPie' extension"
                id="gui.extension.raspberryPie.description"
            />
        ),
        featured: true
    }
